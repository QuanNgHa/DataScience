...
<script.py> output:
    {'text': 'show me Chinese food in the centre of town', 
     ...
     'entities': [{'end': 34, 'value': 'centre', 'entity': 'location', 'extractor': 'ner_crf', 'start': 28}]}
    {'text': 'I want an Indian restaurant in the west', 
     'intent': {'confidence': 0.0, 'name': ''}, 
      'entities': [{'end': 16, 'value': 'indian', 'entity': 'cuisine', 'extractor': 'ner_crf', 'start': 10}, {'end': 39, 'value': 'west', 'entity': 'location', 'extractor': 'ner_crf', 'start': 35}]}
    {'text': 'are there any good pizza places in the center?', 
     'intent': {'confidence': 0.0, 'name': ''}, 
     'entities': [{'end': 45, 'value': 'center', 'entity': 'location', 'extractor': 'ner_crf', 'start': 39}]}
```
